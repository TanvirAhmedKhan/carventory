                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                                <p>This project was developed in response to a technical test provided by Carsales.com.au</p>
                                <p className="h6">&copy All right Reversed.<a className="text-green ml-2" href="https://www.linkedin.com/in/ta9vir/" target="_blank">Tanvir Ahmed Khan</a></p>
                            </div>
                            <hr/>
                        </div>	
                    </div>
